...
MPDSettings::MPDSettings(const char *host, unsigned port, unsigned timeout_ms, const char *reserved, const char *password, QObject *parent): AbstractMPDSettings(host, port, timeout_ms, reserved, password, parent)
{
